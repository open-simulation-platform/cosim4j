...
object CosimLibrary {
     ...
     *
     */
    external fun getRealSamples(observer: ObserverPtr, slaveIndex: Int, vr: Long, stepNumber: Long, nSamples: Int): CosimRealSamples
     ...
     *
     */
    external fun getIntegerSamples(observer: ObserverPtr, slaveIndex: Int, vr: Long, stepNumber: Long, nSamples: Int): CosimIntegerSamples
