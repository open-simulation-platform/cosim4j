...
JNIEXPORT jlong JNICALL Java_org_osp_cse_jni_CseLibrary_createExecution(JNIEnv* env, jobject, jdouble startTime, jdouble stepSize)
{
...
JNIEXPORT jlong JNICALL Java_org_osp_cse_jni_CseLibrary_createSspExecution(JNIEnv* env, jobject, jstring sspPath, jboolean startTimeDefined, jdouble startTime)
{
...
JNIEXPORT jlong JNICALL Java_org_osp_cse_jni_CseLibrary_createCseConfigExecution(JNIEnv* env, jobject, jstring configPath, jboolean startTimeDefined, jdouble startTime)
{
...
JNIEXPORT jlong JNICALL Java_org_osp_cse_jni_CseLibrary_createFixedStepSspExecution(JNIEnv* env, jobject, jstring sspDir, jdouble stepSize, jboolean startTimeDefined, jdouble startTime)
{
...
JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_destroyExecution(JNIEnv* env, jobject, jlong executionPtr)
{
    if (executionPtr == 0) {
...
JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_start(JNIEnv* env, jobject, jlong executionPtr)
{
    return cse_execution_start(reinterpret_cast<cse_execution*>(executionPtr)) == 0;
}

JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_step(JNIEnv* env, jobject, jlong executionPtr, jlong numSteps)
{
    return cse_execution_step(reinterpret_cast<cse_execution*>(executionPtr), numSteps) == 0;
}

JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_simulateUntil(JNIEnv* env, jobject, jlong executionPtr, jdouble targetTime)
{
    return cse_execution_simulate_until(reinterpret_cast<cse_execution*>(executionPtr), to_cse_time_point(targetTime)) == 0;
}

JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_stop(JNIEnv* env, jobject, jlong executionPtr)
{
    return cse_execution_stop(reinterpret_cast<cse_execution*>(executionPtr)) == 0;
}

JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_enableRealTimeSimulation(JNIEnv* env, jobject, jlong executionPtr)
{
    if (executionPtr == 0) {
        std::cerr << "[JNI-wrapper] Error: executionPtr is NULL" << std::endl;
        return false;
...
JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_disableRealTimeSimulation(JNIEnv* env, jobject, jlong executionPtr)
{
    if (executionPtr == 0) {
        std::cerr << "[JNI-wrapper] Error: executionPtr is NULL" << std::endl;
        return false;
...
JNIEXPORT jboolean JNICALL Java_org_osp_cse_jni_CseLibrary_setRealTimeFactorTarget(JNIEnv* env, jobject, jlong executionPtr, jdouble realTimeFactor)
{
    if (executionPtr == 0) {
        std::cerr << "[JNI-wrapper] Error: executionPtr is NULL" << std::endl;
        return false;
...
JNIEXPORT jobject JNICALL Java_org_osp_cse_jni_CseLibrary_getStatus(JNIEnv* env, jobject, jlong executionPtr)
{
    if (executionPtr == 0) {
        std::cerr << "[JNI-wrapper] Error: executionPtr is NULL" << std::endl;
        return nullptr;
