...
{
    jclass cls = env->FindClass("org/osp/cse/CseRealSamples");
    ...
    auto numSamplesRead = (int)cse_observer_slave_get_real_samples(
        reinterpret_cast<cse_observer*>(observerPtr),
        slaveIndex,
        static_cast<cse_value_reference>(vr),
        static_cast<cse_step_number>(fromStep),
        nSamples,
        values,
        steps,
        times);
...
{
    jclass cls = env->FindClass("org/osp/cse/CseIntegerSamples");
    jmethodID ctor = env->GetMethodID(cls, "<init>", "(I[J[D[D)V");
    ...
    auto numSamplesRead = (int)cse_observer_slave_get_integer_samples(
        reinterpret_cast<cse_observer*>(observerPtr),
        slaveIndex,
        static_cast<cse_value_reference>(vr),
        static_cast<cse_step_number>(fromStep),
